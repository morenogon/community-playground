              ...
              {({
                ...
                <Form onSubmit={handleSubmit}>
                  {!isRegistered && (
                    <label>
                      Full name
                      <Field type="text" name="fullname" value={fullName} onChange={(e) => setFullName(e.target.value)} onBlur={handleBlur}
                      />
                    </label>
                  )}
                  ...
                  {!isRegistered && (
                    <label>
                      User name
                      <Field type="text" name="username" value={userName} onChange={(e) => setUserName(e.target.value)} onBlur={handleBlur} />
                    </label>
                  )}
                  ...
                  {!isRegistered && (
                    <label>
                      Profile picture
                      <Field type="text" name="profilepic" value={profilePic} onChange={(e) => setProfilePic(e.target.value)} onBlur={handleBlur} />
                    </label>
                  )}
                  ...
                  {!isRegistered && (
                    <label>
                      Quote
                      <Field type="text" name="quote" value={quote} onChange={(e) => setQuote(e.target.value)} onBlur={handleBlur} />
                    </label>
                  )}
                  {errors.quote && touched.quote && errors.quote}
                  <label>
                    Email
                    <Field type="email" name="email" value={email} onChange={(e) => setEmail(e.target.value)} onBlur={handleBlur} />
                  </label>
                  <label className="login__password-label">
                    Password
                    <Field type={passwordShown ? 'text' : 'password'} name="password" value={password} onChange={(e) => setPassword(e.target.value)} onBlur={handleBlur} />
